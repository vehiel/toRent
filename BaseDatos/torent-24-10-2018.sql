...
(6,'Atornillador',NULL),
(7,'Esmeril',NULL),
(14,'prueba','yamaha-cage-six-xl.jpg');
...
(1,1,1,1,'amarrillo con negro',5,12,1,1,0,'123qwerty',NULL,0,0.00);
...
CREATE TABLE `tr11ord_alq` (
  ...
  `sto_11de` decimal(10,2) DEFAULT NULL COMMENT 'Subtotal',
  `mto_11de` decimal(10,2) DEFAULT NULL COMMENT 'Monto Total',
...
insert  into `tr11ord_alq`(`ido_11in`,`ncl_06in`,`fso_11dt`,`fre_11dt`,`fde_11dt`,`sto_11de`,`mto_11de`,`est_11in`) values 
(1,3,'2018-10-24 00:00:00',NULL,NULL,10000.00,10000.00,1);
...
CREATE TABLE `tr12det_alq` (
  ...
  `mto_12de` decimal(10,2) NOT NULL COMMENT 'Monto Total',
...
insert  into `tr12det_alq`(`idd_12in`,`ido_11in`,`chr_10in`,`pre_12de`,`can_12in`,`mto_12de`) values 
(1,1,1,5000.00,2,10000.00);
